...
public class SorumFrame extends JFrame {
    ...
    public SorumFrame() {
        ...
        JLabel labelJenisMotor = new JLabel("Jenis mobil :");
        labelJenisMotor.setForeground(Color.white);
        labelJenisMotor.setBounds(15, 150, 350, 30);
        radioButtonL = new JRadioButton("MVP", true);
        radioButtonL.setBounds(15, 175, 350, 30);
        radioButtonP = new JRadioButton("SUV");
        radioButtonP.setBounds(15, 200, 350, 30);

        JLabel labelJenis = new JLabel("Merek mobil :");
        ...
        JLabel labelNamotor = new JLabel("Nama Mobil :");
        ...
        JLabel labelTitlee = new JLabel("<< TABEL DAFTAR NOTA PEMBELIAN MOBIL >>");
    ...
    public void populateComboMermo(List<Mermo> mermoList) {
        ...
        for (Mermo mermo : mermoList) {
            comboMerek.addItem(mermo.getMerekmobil());
        }
    }
    ...
    public void populateComboNamot(List<Namot> namotList) {
        ...
        for (Namot namot : namotList) {
            comboNamot.addItem(namot.getNamamobil());
        }
    }
    ...
    public Mermo getMerekmobil() {
        return mermoList.get(comboMerek.getSelectedIndex());
    }

    public Namot getNamamobil() {
