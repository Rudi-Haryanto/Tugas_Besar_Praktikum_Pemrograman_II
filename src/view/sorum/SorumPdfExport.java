...
public class SorumPdfExport {
    public void export(List<Sorum> sorumList) throws IOException {
        String outputFileName = System.getProperty("user.dir") +
                File.separator + "pdf" + File.separator + "Nota_Showroom_" + UUID.randomUUID()
                + ".pdf";
        ...
        Cell<PDPage> cell = headerRow.createCell(100, "<<< Nota Showroom >>>");
        ...
        cell.setFont(fontBold);
        cell.setFontSize(15);
        cell = row.createCell(20, "Nama Mobil");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFont(fontBold);
        cell.setFontSize(15);
        ...
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        cell = row.createCell(15, "Jenis Mobil");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        cell = row.createCell(20, "Merek");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        cell = row.createCell(17, "Nama mobil");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        ...
        for (Sorum sorum : sorumList) {
            ...
            cell.setFontSize(15);
            cell = row.createCell(20, sorum.getMermo().getMerekmobil());
            cell.setFontSize(15);
            cell = row.createCell(17, sorum.getNamot().getNamamobil());
            cell.setFontSize(15);
            no++;
        }
