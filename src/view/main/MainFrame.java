...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        JLabel labelInput = new JLabel("Selamat Datang di FRECS-Showroom");
        labelInput.setForeground(Color.WHITE);
        labelInput.setText("Selamat Datang di FRECS-Showroom");
