...
public class NamotFrame extends JFrame {
    ...
    public NamotFrame() {
        ...
        JLabel labelTitlee1 = new JLabel(" Halaman Inputan Mobil ");
        labelTitlee1.setBounds(120, 15, 350, 10);
        labelTitlee1.setForeground(Color.white);

        JLabel labelInput = new JLabel("Nama Mobil :");
    ...
    public String takeNamot() {
        ...
        if (selection.length > 0) {
            String namamobil = (String) tableModel.getValueAt(selection[0], 1);
            return namamobil;
        } else {
            return "";
        }
